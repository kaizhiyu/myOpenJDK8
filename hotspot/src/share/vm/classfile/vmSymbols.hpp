...
class vmSymbols: AllStatic {
 ...
 public:
  // enum for figuring positions and size of array holding Symbol*s  用于计算包含符号*的数组的位置和大小的枚举
  enum SID {
    NO_SID = 0,
 ...
 private:
  // The symbol array  符号数组
  static Symbol* _symbols[];

  // Field signatures indexed by BasicType. 按基本类型索引的字段签名
