...
// Closure provides abortability. 闭包提供可中止性。
...
class Closure : public StackObj {
 ...
 public:
  ...
  // functions that the iteration should cease. 子类型可以使用此机制向某些迭代器映射函数指示迭代应停止。
  bool abort() { return _abort; }
  void clear_abort() { _abort = false; }
};

// OopClosure is used for iterating through references to Java objects. OopClosure用于遍历对Java对象的引用。
