...
// an illusion of a contiguous Eden and optionally retires the tlab. 用一个虚拟填充数组填充当前的tlab，以创建一个相邻Eden的幻觉，并有选择地使tlab失效。
// Waste accounting should be done in caller as appropriate; see,    应根据需要在调用方中进行废物核算
